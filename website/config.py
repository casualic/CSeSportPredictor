...
# IMPORTANT: This order must match the column order from build_features() in
# train_model_fsvm.py, since the scaler and FSVM model were trained with this order.
LEAN_COLS = [
    "elo_diff", "rank_diff", "rank_ratio", "log_rank_ratio",
    "dyn_rank_diff", "dyn_log_rank_ratio",
    "elo_rank_diff", "log_elo_rank_ratio",
    "form_diff", "streak_diff", "h2h_winrate", "h2h_matches",
    "elo_expected", "momentum_diff", "vs_strong_diff",
    "map_pool_depth_diff", "map_wr_overlap",
