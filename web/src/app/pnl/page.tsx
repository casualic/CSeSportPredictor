...
export default async function PnL({ searchParams }: { searchParams: Promise<{ tier?: string }> }) {
  ...
  return (
    <>
      ...
      {cumulative.length > 0 && (
        <div className="bg-white border border-slate-400 rounded-[6px] p-5 mb-7">
      ...
      {reversed.length > 0 ? (
        <>
          <h3 className="font-serif text-lg font-semibold text-slate-900 mb-3">Bet History</h3>
            ...
            <table className="w-full border-collapse">
              ...
              <tbody>
                {reversed.map((b, i) => (
                  ...
                  >
                    <td className="py-3.5 px-[18px] align-middle font-mono text-[13px] text-slate-400">
                      {reversed.length - i}
                    </td>
                    ...
                    <td className="py-3.5 px-[18px] align-middle font-mono text-[13px] font-medium text-green-600">
                    ...
                    <td
                      className={`py-3.5 px-[18px] align-middle font-mono text-[13px] font-medium ${
